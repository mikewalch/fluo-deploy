...
SERVICES = ['zookeeper', 'namenode', 'resourcemanager', 'accumulomaster', 'mesosmaster', 'worker', 'fluo', 'metrics', 'kubernetesmaster']
  ...
  def verify_config(self, action):
    ...
    if action in ['launch', 'setup']:
      ...
      for service in SERVICES:
        if service not in ['fluo', 'metrics', 'mesosmaster', 'kubernetesmaster']:
